...
public class Gitbeans {

    public static void main(String[] args) {
        System.out.println("create new repo on github, initialise with read-me and ignore");
        System.out.println("click (clone or download) copy url");
